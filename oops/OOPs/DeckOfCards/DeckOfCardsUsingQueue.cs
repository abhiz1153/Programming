...
namespace OOPs.DeckOfCards
{
    ...
    public class DeckOfCardsUsingQueue
    {
        ...
        public void InitializeDeckOfCardsUsingQueue()
        {
            ...
            {
                this.list = queue.Enqueue(PlayerList1, element);
            }
            this.list = queue.Dequeue(list, PlayerList1);
            this.PlayerList1 = list.AddPlayerInList(list);
            for (int playernumber = 1; playernumber <= 4; playernumber++)
            {
                this.DistributeCard(playernumber);
        ...
        public void SuffleCard(int playernumber)
        {
            ...
            {
               this.cards[suit, rank] = playernumber;
                return;
            }
            else
               this.SuffleCard(playernumber);
