// --------------------------------------------------------------------------------------------------------------------
// <copyright file=ProductionManager.cs" company="Bridgelabz">
...
namespace DesignPatterns.FactoryPattern
{
    ...
    class ProductionManager : Employee
    {
        ...
        public ProductionManager(int employeeId, string employeeName, double employeeSalary, int target, double incentive) : base(employeeId, employeeName, employeeSalary)
        {
            this.Target = target;
        ...
        {
            return (base.Display() + "\nTotal Monthly Product Build :-" + this.Target + "\nProduction Manager Monthly Incentive is :- Rs. " + this.Incentive);
        }
    }
}
